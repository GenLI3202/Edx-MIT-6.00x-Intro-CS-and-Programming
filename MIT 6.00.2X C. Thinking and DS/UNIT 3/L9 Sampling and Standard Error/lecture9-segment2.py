...
# =============================================================================
pylab.axvline(x = popMean, color = 'r') # draw a red vertical line ('r')
# =============================================================================
...
def showErrorBars(population, sizes, numTrials):
    ...
    pylab.errorbar(xVals, sizeMeans,
                   yerr = 1.96*pylab.array(sizeSDs),       # yerr: vertical bars parallel to the y-axis 
                   fmt = 'o',    # the format we are ganna print is the points with sigle 'o'.
