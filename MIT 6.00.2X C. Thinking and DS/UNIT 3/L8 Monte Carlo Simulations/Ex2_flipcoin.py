...
#     In [33]: list(range(10,500,50))
#     Out[33]: [10, 60, 110, 160, 210, 260, 310, 360, 410, 460]
...
def clt():
    ...
    for sampleSize in sampleSizes:
        ...
        for t in range(20):
            ...
            # create a sample which is the result of flipping ''sampleSize'' times 
            sampleMeans.append(getMeanAndStd(sample)[0])
            # get the mean value of this sample, store it in the sampleMeans
        # print(sampleMeans)
