...
def fitData1(fileName):
    ...
    # the different lines ↑: , using this formulation
        # of assigning the result to a single variable,
        # and then using polyval, makes the code independent
        # of the degree of the polynomial.
        # So we can call the same code with polynomials
        # of lots of different degrees.
    pylab.plot(xVals, estYVals, 'r',
               label = 'Linear fit, k = '
